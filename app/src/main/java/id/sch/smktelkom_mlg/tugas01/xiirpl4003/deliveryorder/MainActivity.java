package id.sch.smktelkom_mlg.tugas01.xiirpl4003.deliveryorder;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void doClick() {
        if (isValid()) {
            ...
            if (hasil == null) {
                tvhasil.setText("Anda belum mengisi jenis pembayaran");
            } else {
                String bimbel = "\t Menu yang dipilih : \t\n";
